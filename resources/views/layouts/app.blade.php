        ...
        <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                <div class="navbar-brand navbar-brand-autodark">
                    <a href="{{ route(auth()->user()->prefix . 'dashboard.index') }}" aria-label="NexaCampus">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="d-none d-md-flex me-3">
                        ...
                        <div class="nav-item d-flex align-items-center">
                            <div class="d-flex align-items-center p-1 rounded-pill border theme-switch-pill" style="gap: 4px; background: rgba(148,163,184,0.12);">
                                <a href="?theme=light" class="btn btn-icon rounded-pill border-0 theme-btn-light d-flex align-items-center justify-content-center" title="Mode Terang" data-bs-toggle="tooltip" style="width: 32px; height: 32px; text-decoration: none;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon m-0"><path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7" /></svg>
                                </a>
                                <a href="?theme=dark" class="btn btn-icon rounded-pill border-0 theme-btn-dark d-flex align-items-center justify-content-center" title="Mode Gelap" data-bs-toggle="tooltip" style="width: 32px; height: 32px; text-decoration: none;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon m-0"><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
                                </a>
                            </div>
                        </div>
                        <!-- END THEME TOGGLE -->
