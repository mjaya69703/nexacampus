                ...
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <a href="{{ route('auth.switch-role') }}" class="dropdown-item">
                            ...
                            @guest
                            <a href="{{ route('auth.signin-index') }}" class="dropdown-item">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3 d-flex gap-3">
                            ...
                            <span class="text-muted">{{ $campus->alamat }}</span>
                        </li>
                        <li class="mb-3 d-flex gap-3">
                            ...
                            <span class="text-muted">{{ $campus->whatsapp }}</span>
                        </li>
                        <li class="mb-3 d-flex gap-3">
                            ...
                            <span class="text-muted">Info : {{ $campus->email_info }}</span>
                        </li>
                        <li class="mb-3 d-flex gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            ...
                            <span class="text-muted">Humas : {{ $campus->email_humas }}</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-9 text-lg-start text-center">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item">Copyright © {{ \Carbon\Carbon::now()->translatedFormat('F Y') }} <a href="{{ $system->app_url }}" class="link-secondary">{{ $system->app_name }} - {{ $campus->name }} </a>. All rights reserved.</li>
                    ...
                    <div class="col-lg-3 mt-3 mt-lg-0 text-lg-end text-center">
                        <img src="{{ $campus->logo_horizontal }}" style="max-width: 200px; max-height: 128px" alt="Logo" class="h-8">
                    </div>
                </div>
            </div>
        </div>
