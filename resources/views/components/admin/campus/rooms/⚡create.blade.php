    ...
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="name" class="form-control" placeholder="Contoh: Ruang 101" wire:model.defer="roomForm.name">
                @error('roomForm.name')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="code" class="form-control" placeholder="Contoh: R-101" wire:model.defer="roomForm.code">
                @error('roomForm.code')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="floor" class="form-control" placeholder="Contoh: 1" wire:model.defer="roomForm.floor">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="number" id="capacity" class="form-control" placeholder="Contoh: 30" wire:model.defer="roomForm.capacity" min="1">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <textarea id="desc" class="form-control" placeholder="Deskripsi ruangan" wire:model.defer="roomForm.desc" rows="4"></textarea>
                @error('roomForm.desc')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 mt-4">
                <button type="button" class="btn btn-primary" wire:click="createRoom">
