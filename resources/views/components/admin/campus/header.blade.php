@props([
    'title' => 'Modul Kampus',
    'description' => 'Kelola data dan parameter kampus dengan cepat dan terstruktur.',
    'icon' => 'building',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #0f766e 0%, #1d4ed8 55%, #111827 100%); position: relative;">
