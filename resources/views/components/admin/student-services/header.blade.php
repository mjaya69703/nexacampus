@props([
    'title' => 'Layanan Mahasiswa & Akademik',
    'description' => 'Kelola administrasi, surat, cuti, perpindahan, yudisium, dan pengaduan mahasiswa secara terpadu.',
    'icon' => 'user-graduate',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #4f46e5 0%, #0891b2 55%, #0f172a 100%); position: relative;">
