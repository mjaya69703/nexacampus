@props([
    'title' => 'Modul Kepegawaian & Organisasi',
    'description' => 'Kelola struktur kepegawaian, jabatan, unit kerja, absensi, cuti, serta beban kerja dosen.',
    'icon' => 'users-cog',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #4f46e5 0%, #3b82f6 55%, #1e1b4b 100%); position: relative;">
