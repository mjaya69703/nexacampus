...
<div>
    ...
    <x-admin.organization.header
        title="Edit Penugasan Jabatan"
        description="Perbarui data penugasan untuk pegawai: {{ $assignment->employeeProfile?->user?->name }} ({{ $assignment->position?->name }})"
        icon="user-edit"
    >
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Formulir Perubahan Penugasan</h4>
                            <div class="text-muted small">Sesuaikan jabatan, masa berlaku, atau scope lingkup kewenangan pegawai ini.</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                <div class="card-body p-4 bg-light bg-opacity-50">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1">Dampak Penugasan</h5>
                            <div class="text-muted small">Informasi kewenangan dan lingkup kerja.</div>
                        </div>
                    </div>

                    <ul class="list-unstyled mb-0 text-muted small d-grid gap-2">
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Perubahan masa berlaku (Tanggal Mulai/Selesai) akan membatasi hak akses sistem sesuai periode aktif SK.</span></li>
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Menjadikan jabatan sebagai <strong>Utama</strong> akan menggantikan status utama pada penugasan lainnya jika ada.</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-4">
                    ...
                    <div class="fw-bold fs-5 {{ $assignment->is_active ? 'text-success' : 'text-danger' }} mb-2">{{ $assignment->is_active ? 'Aktif' : 'Nonaktif' }}</div>
                    <p class="text-muted small mb-0">Penugasan nonaktif tidak akan dimasukkan ke dalam perhitungan struktur organisasi aktif.</p>
                </div>
            </div>
        </div>
    </div>
