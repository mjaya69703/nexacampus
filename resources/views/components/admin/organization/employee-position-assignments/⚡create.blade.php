...
new class extends Component
{
    ...
    public function save(EmployeePositionAssignmentService $service): void
    {
        ...
        session()->flash('success', 'Penugasan jabatan berhasil dibuat.');
    ...
    public function render()
    {
        return $this->view()->layout('layouts.app', [
            'menus' => 'Kepegawaian',
            'pages' => 'Tambah Penugasan Jabatan',
        ]);
    }
...
<div>
    ...
    <x-admin.organization.header
        title="Tambah Penugasan Jabatan"
        description="Tetapkan penugasan jabatan struktural atau fungsional kepada pegawai beserta cakupan lingkup wewenangnya."
        icon="user-plus"
    >
        <a href="{{ route('admin.organization.employee-position-assignments.index') }}" class="btn btn-sm btn-light text-dark fw-semibold d-inline-flex align-items-center gap-2 shadow-sm rounded-pill px-3 py-2">
    ...
    <div class="row g-4 align-items-start">
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Formulir Penugasan Pegawai</h4>
                            <div class="text-muted small">Pilih pegawai dan jabatan yang ditugaskan, pastikan scope data akademis atau unit kerja telah sesuai.</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                <div class="card-body p-4 bg-light bg-opacity-50">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1">Cakupan Wewenang</h5>
                            <div class="text-muted small">Ketentuan lingkup (scope) jabatan.</div>
                        </div>
                    </div>

                    <ul class="list-unstyled mb-0 text-muted small d-grid gap-2">
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Scope <strong>Fakultas</strong> memberikan kewenangan akses dan verifikasi seluruh data di tingkat fakultas.</span></li>
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Scope <strong>Program Studi</strong> membatasi kewenangan hanya pada prodi yang bersangkutan.</span></li>
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Scope <strong>Unit Kerja</strong> otomatis menambahkan pegawai ke keanggotaan unit kerja tersebut.</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-4">
                    <div class="text-muted small mb-1">Status Penugasan</div>
                    <div class="fw-bold fs-5 text-dark mb-2">Aktif / Utama</div>
                    <p class="text-muted small mb-0">Jabatan utama akan diutamakan saat mencetak dokumen resmi, surat keputusan (SK), dan absensi.</p>
                </div>
            </div>
        </div>
    </div>
