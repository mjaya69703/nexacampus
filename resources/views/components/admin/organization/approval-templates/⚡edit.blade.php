...
<div>
    ...
    <x-admin.organization.header
        title="Edit Template Approval"
        description="Perbarui informasi dan susunan langkah persetujuan pada template: {{ $template->name }} ({{ $template->code }})"
        icon="edit"
    >
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Formulir Perubahan Template</h4>
                            <div class="text-muted small">Sesuaikan parameter atau langkah approval sesuai kebijakan operasional terbaru.</div>
                        </div>
                    </div>
                </div>
