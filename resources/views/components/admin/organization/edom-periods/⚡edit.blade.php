...
<div>
    ...
    <x-admin.organization.header
        title="Edit Periode EDOM"
        description="Perbarui pengaturan jadwal, status pembukaan, atau batas waktu evaluasi untuk periode: {{ $period->name }} ({{ $period->code }})"
        icon="calendar-check"
    >
            ...
            <form wire:submit.prevent="save" class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Formulir Perbaikan Periode</h4>
                            <div class="text-muted small">Sesuaikan parameter jadwal evaluasi sesuai kalender akademik.</div>
                        </div>
                    </div>
                </div>
