@props([
    'title' => 'Manajemen Keuangan & Pembiayaan Kampus',
    'description' => 'Kelola tagihan mahasiswa, pembayaran uang kuliah, beasiswa, pengajuan cicilan, serta laporan keuangan kampus secara terintegrasi.',
    'icon' => 'file-invoice-dollar',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #1e3a8a 0%, #0369a1 55%, #0f172a 100%); position: relative;">
