...
<div>
    <x-alert />
    <div class="card">
        <div class="card-header"><h3 class="card-title">Tambah Kampanye Tracer Study</h3></div>
        <div class="card-body row">
                    ...
                    <div class="card mb-3">
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-8 mt-2">
                                ...
                                @error("questions.{$index}.text") <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            @if (in_array($q['type'], ['radio', 'select']))
                                <div class="form-group col-12 mt-2">
                                    <label>Opsi (satu per baris)</label>
                                    <textarea class="form-control" rows="3" wire:model.defer="questions.{{ $index }}.options" placeholder="Opsi 1&#10;Opsi 2&#10;Opsi 3"></textarea>
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="form-group col-12 mt-4 d-flex align-items-center justify-content-end gap-2">
                <button class="btn btn-primary" wire:click="createTracerStudyCampaign">
