...
<div>
    <x-alert />
    <div class="card">
        <div class="card-header"><h3 class="card-title">Tambah Event Alumni</h3></div>
        <div class="card-body row">
            ...
            <div class="form-group col-lg-4 col-md-6 col-sm-12 mt-2">
                ...
                @error('form.event_type') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-lg-4 col-md-6 col-sm-12 mt-2">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="url" id="meeting_url" class="form-control" wire:model.defer="form.meeting_url" placeholder="https://zoom.us/...">
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
            ...
            <div class="form-group col-12 mt-4 d-flex align-items-center justify-content-end gap-2">
                <button class="btn btn-primary" wire:click="createAlumniEvent">
