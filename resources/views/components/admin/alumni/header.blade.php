@props([
    'title' => 'Modul Alumni & Career Center',
    'description' => 'Kelola data alumni, lowongan pekerjaan, mitra perusahaan, agenda kegiatan, dan survei tracer study kampus.',
    'icon' => 'user-graduate',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #0284c7 0%, #1d4ed8 55%, #0f172a 100%); position: relative;">
