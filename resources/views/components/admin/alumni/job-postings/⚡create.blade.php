...
<div class="w-full" style="width: 100% !important">
    ...
    <x-admin.alumni.header
        title="Publikasi Lowongan Karir Baru"
        description="Buat pengumuman peluang kerja, magang, atau rekrutmen kampus untuk dipublikasikan kepada jaringan alumni."
        icon="briefcase"
    >
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Form Detail Lowongan</h4>
                            <div class="text-muted small">Lengkapi informasi posisi dan kualifikasi yang dibutuhkan secara jelas.</div>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <input type="text" id="title" class="form-control rounded-3" placeholder="Contoh: Senior Full Stack Developer" wire:model.defer="form.title">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <input type="text" id="company_name" class="form-control rounded-3" placeholder="Contoh: PT Teknologi Nusantara" wire:model.defer="form.company_name">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <input type="text" id="location" class="form-control rounded-3" placeholder="Contoh: Jakarta / Remote" wire:model.defer="form.location">
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <label for="salary_range" class="form-label fw-semibold">Rentang Gaji</label>
                            <input type="text" id="salary_range" class="form-control rounded-3" placeholder="Contoh: 8 - 12 Juta / Kompetitif" wire:model.defer="form.salary_range">
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <input type="url" id="apply_url" class="form-control rounded-3" placeholder="https://company.com/careers/apply" wire:model.defer="form.apply_url">
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <label for="contact_email" class="form-label fw-semibold">Email Pengiriman CV</label>
                            <input type="email" id="contact_email" class="form-control rounded-3" placeholder="recruitment@company.com" wire:model.defer="form.contact_email">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description" class="form-control rounded-3" rows="4" wire:model.defer="form.description" placeholder="Jelaskan tanggung jawab utama, lingkup proyek, atau budaya tim..."></textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="requirements" class="form-control rounded-3" rows="4" wire:model.defer="form.requirements" placeholder="Sebutkan latar belakang pendidikan, keahlian teknis, dan pengalaman yang dibutuhkan..."></textarea>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            <div class="border rounded-4 p-3 bg-light bg-opacity-50">
                                ...
                                <div class="text-muted small mt-1">Jika nonaktif, lowongan akan disimpan sebagai draft internal admin.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-end mt-4">
                        ...
                        <button type="button" class="btn btn-primary rounded-pill px-4" wire:click="createJobPosting">
                            <i class="fa fa-save me-2"></i> Simpan Lowongan Kerja
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                <div class="card-body p-4 bg-light bg-opacity-50">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1">Panduan Lowongan</h5>
                            <div class="text-muted small">Pengumuman karir yang informatif menarik kandidat alumni terbaik.</div>
                        </div>
                    </div>

                    <ul class="list-unstyled mb-0 text-muted small d-grid gap-2.5">
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Jika lowongan berasal dari <strong>Mitra Perusahaan</strong> terdaftar, pilih mitra dari dropdown agar logo terhubung otomatis.</span></li>
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span>Pastikan batas waktu akhir lamaran (deadline) diatur minimal sama atau setelah tanggal posting.</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-0">Lowongan langsung dapat diakses oleh alumni melalui halaman bursa kerja kampus.</p>
                </div>
            </div>
        </div>
    </div>
