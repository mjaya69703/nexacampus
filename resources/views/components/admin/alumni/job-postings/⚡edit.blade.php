...
<div>
    <x-alert />
    <div class="card">
        <div class="card-header"><h3 class="card-title">Edit Lowongan: {{ $form['title'] ?? '' }}</h3></div>
        <div class="card-body row">
            ...
            <div class="form-group col-lg-4 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="salary_range" class="form-control" wire:model.defer="form.salary_range">
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
            ...
            <div class="form-group col-12 mt-4 d-flex align-items-center justify-content-end gap-2">
                <button class="btn btn-primary" wire:click="updateJobPosting">
