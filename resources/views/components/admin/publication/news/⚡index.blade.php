...
<div class="w-full" style="width: 100% !important">
    ...
    >
        @activecan('news.create')
            <a href="{{ route('admin.publication.news.create') }}" class="btn btn-sm btn-light text-success fw-semibold d-inline-flex align-items-center gap-2 shadow-sm rounded-pill px-3 py-2">
