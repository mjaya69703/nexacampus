...
<div class="w-full" style="width: 100% !important">
    ...
    <x-admin.publication.header
        title="Buat FAQ Baru"
        description="Buat pertanyaan dan jawaban FAQ baru dengan menentukan tipe modul, kategori, urutan penayangan, dan status aktif."
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Form FAQ</h4>
                            <div class="text-muted small">Lengkapi pertanyaan dan jawaban FAQ secara lengkap dan jelas.</div>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="mb-0">
                        ...
                        <livewire:jodit-text-editor wire:model.live="answer" identifier="faq-create-answer" :height="350" />
                        @error('answer')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
