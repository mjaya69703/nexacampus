@props([
    ...
    'description' => 'Kelola pengumuman dan informasi penting untuk seluruh civitas akademika.',
    'icon' => 'bullhorn',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #d97706 0%, #b45309 55%, #78350f 100%); position: relative;">
