...
<div class="w-full" style="width: 100% !important">
    ...
    <x-admin.publication.header
        ...
        description="Buat agenda atau acara baru dengan menentukan judul, jadwal, lokasi, kategori, dan status publikasi."
        icon="calendar-days"
    >
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Form Agenda</h4>
                            <div class="text-muted small">Lengkapi data agenda secara lengkap dan konsisten.</div>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-3 bg-light" placeholder="Auto-generated from title" wire:model="slug" readonly>
                        @error('slug')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
