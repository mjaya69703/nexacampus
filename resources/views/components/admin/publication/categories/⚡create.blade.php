...
new class extends Component
{
    ...
    public function save(): void
    {
        $this->validate([
            ...
            'slug' => 'required|string|max:100|unique:publication_categories,slug',
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Form Kategori</h4>
                            <div class="text-muted small">Lengkapi informasi kategori publikasi secara lengkap dan jelas.</div>
                        </div>
                    </div>
                </div>
