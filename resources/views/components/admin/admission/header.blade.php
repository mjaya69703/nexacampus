@props([
    ...
    'description' => 'Kelola gelombang pendaftaran, kuota penerimaan, jadwal ujian masuk, seleksi calon mahasiswa, serta aturan NIM secara komprehensif.',
    'icon' => 'user-plus',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #047857 0%, #0d9488 55%, #0f172a 100%); position: relative;">
