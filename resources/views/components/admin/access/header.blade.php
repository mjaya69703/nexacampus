@props([
    ...
    'description' => 'Kelola user, role, dan permission secara rapi dan aman.',
    'icon' => 'shield-halved',
    'eyebrow' => 'Access Control',
    'stats' => null,
])

<div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #1e3a8a 0%, #312e81 52%, #111827 100%); position: relative;">
    ...
    <div class="card-body p-4 p-md-4 text-white" style="position: relative; z-index: 2;">
        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="text-uppercase text-white text-opacity-75 fw-bold small mb-1">{{ $eyebrow }}</div>
                    <h2 class="card-title text-white fw-bold fs-3 mb-1 tracking-tight">{{ $title }}</h2>
                    <p class="text-white text-opacity-85 mb-0 fs-6" style="max-width: 720px; line-height: 1.45;">{{ $description }}</p>
                </div>
            </div>
