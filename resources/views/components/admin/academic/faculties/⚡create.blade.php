...
<div>
    ...
    <x-admin.academic.header
        ...
        description="Daftarkan unit fakultas baru yang akan menaungi berbagai program studi akademik di kampus."
        icon="plus-circle"
    >
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="card-title fw-bold mb-1 text-dark">Formulir Fakultas</h4>
                            <div class="text-muted small">Tentukan nama lengkap fakultas, kode unik, nama singkat, dan status ketersediaan.</div>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4 row g-3">
                    ...
                    <div class="col-12">
                        <label class="form-label fw-semibold" for="desc">Deskripsi / Ketersediaan</label>
                        <textarea id="desc" class="form-control" rows="3" wire:model.defer="facultyForm.desc" placeholder="Deskripsi mengenai fakultas ini (opsional)"></textarea>
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch mt-2">
                            ...
                            <label for="is_active" class="form-check-label fw-semibold">Aktifkan Fakultas Sekarang</label>
                        </div>
                    ...
                    <div class="col-12 border-top pt-3 mt-4 d-flex align-items-center justify-content-end gap-2">
                        ...
                        <button class="btn btn-primary rounded-pill px-4 py-2 shadow-sm" wire:click="createFaculty" type="button">
                            <i class="fa fa-save me-1"></i> Simpan Fakultas
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                <div class="card-body p-4 bg-light bg-opacity-50">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1">Pedoman Fakultas</h5>
                            <div class="text-muted small">Panduan pendaftaran unit.</div>
                        </div>
                    </div>

                    <ul class="list-unstyled mb-0 text-muted small d-grid gap-2">
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span><strong>Kode Fakultas:</strong> Gunakan kode singkat unik yang umum dikenali (contoh: <em>FT</em> untuk Fakultas Teknik, <em>FEB</em> untuk Ekonomi & Bisnis).</span></li>
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span><strong>Relasi Prodi:</strong> Setelah fakultas dibuat, Anda dapat mengaitkan Program Studi di bawah fakultas ini.</span></li>
                        <li class="d-flex gap-2"><i class="fa fa-check text-success mt-1"></i><span><strong>Status Aktif:</strong> Menonaktifkan fakultas akan otomatis menonaktifkan seluruh program studi di bawahnya.</span></li>
                    </ul>
                </div>
            </div>
        </div>
