...
<div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Tambah Periode Akademik</h3>
        </div>
        <div class="card-body row">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-12 mt-2">
                ...
                <input type="text" id="code" class="form-control" wire:model.defer="academicPeriodForm.code" placeholder="Opsional">
            ...
            <div class="form-group col-12 mt-4 d-flex align-items-center justify-content-end gap-2">
                <button class="btn btn-primary" wire:click="createAcademicPeriod">
