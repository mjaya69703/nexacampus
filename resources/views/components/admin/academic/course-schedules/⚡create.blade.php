...
<div>
    ...
    <x-admin.academic.header
        ...
        description="Jadwalkan pertemuan kuliah mingguan, tentukan ruang kelas, jam perkuliahan, dan dosen pengampu."
        icon="calendar-plus"
    >
                    ...
                    <div class="card-header bg-white border-bottom p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">Tentukan kelas penawaran, dosen pengampu, hari, waktu mulai dan selesai perkuliahan.</div>
                            </div>
                        </div>
                    </div>
