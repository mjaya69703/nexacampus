...
new class extends Component
{
    ...
    public function updateMenu()
    {
        ...
        if ((int) ($validatedData['menuForm']['parent_id'] ?? 0) === $this->menuId) {
            $this->addError('menuForm.parent_id', 'Parent menu tidak boleh sama dengan menu ini.');
            return;
        }
...
<div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Edit Menu {{ $menuForm['title'] ?? '' }}</h3>
        </div>
        <div class="card-body row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="title" class="form-control" wire:model.defer="menuForm.title">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="url" class="form-control" wire:model.defer="menuForm.url">
                @error('menuForm.url')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="icon" class="form-control" wire:model.defer="menuForm.icon">
                @error('menuForm.icon')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 mt-2">
                ...
                <input type="text" id="permission_name" class="form-control" wire:model.defer="menuForm.permission_name">
            ...
            <div class="form-group col-12 mt-4 d-flex align-items-center justify-content-end gap-2">
                <button class="btn btn-primary" wire:click="updateMenu">
