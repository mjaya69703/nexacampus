...
new class extends Component {
    ...
    public function setRole()
    {
        ...
        if ($roles->contains($selectedRole)) {
            ...
            session()->flash('success', 'Role berhasil dipilih: ' . ucfirst($selectedRole));


            return redirect()->route($user->prefix . 'dashboard.index');
        }

        session()->flash('error', 'Role yang dipilih tidak valid.');
    }
    ...
    public function render()
    {
        ...
        $data = [
            'menus' => 'Authentication', // Data menu
            'pages' => 'Choose Role', // Data halaman
        ...
        $data['roleMeta'] = [
            'superuser' => [
                'desc' => 'Akses superuser dengan semua izin',
        ...
        return $this->view($data)->layout('layouts.home', $data);
    }
};
?>
                ...
                <div class="container-tight">
                    <div class="text-center mb-4">
                        ...
                        <a href="." aria-label="Tabler" class="navbar-brand navbar-brand-autodark">
                            <img src="{{ $campus->logo_horizontal }}" style="height: 64px; width:200px;" alt="Neco Siakad Logo">
                        </a>
                        <!-- END NAVBAR LOGO -->
                    </div>
                    <div class="card card-md">
                        ...
                        <div class="card-body">
                            ...
                            <style>
                                .role-card {
                                    cursor: pointer;
                                    border: 1px solid var(--tblr-border, #e9ecef);
                                ...
                                .role-card.selected {
                                    border-color: var(--tblr-primary, #0455a4);
                                ...
                                .role-card:focus {
                                    outline: none;
                                    box-shadow: 0 0 0 .2rem rgba(4, 85, 164, 0.08);
                                }
                            ...
                            <div class="d-grid gap-3 mb-3" id="role-cards">
                                @foreach ($roles as $role)
                                    @php $r = strtolower($role); @endphp

                                    <div class="card role-card {{ $selectedRole === $r ? 'selected' : '' }}" wire:click="$set('selectedRole','{{ $r }}')">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="me-3">
                                                    {!! $roleMeta[$r]['icon'] ?? '<i class="fas fa-user"></i>' !!}
                                                </div>
                            ...
                            <form wire:submit.prevent="setRole">
                                @csrf
                                <input type="hidden" wire:model="selectedRole" />
                                <div class="form-footer">
                                    <button type="submit" class="btn btn-primary w-100" @disabled(!$selectedRole)>Pilih Role & Lanjutkan</button>
                                </div>
                            </form>
                        </div>
                    </div>
