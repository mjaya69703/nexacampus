...
new class extends Component
{
    ...
    private function loadAnnouncement(): void
    {
        ...
        $announcement = Announcement::queryForStudent($user)
            ->with('creator')
            ->where('id', $this->announcementId)
            ->first();

        if (! $announcement) {
            abort(404, 'Pengumuman tidak ditemukan atau tidak ditujukan untukmu.');
        }
...
<div>
    ...
    @php
        $priority = $announcementData['priority'] ?? null;
    @endphp
            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-wrap gap-3" style="font-size:0.85rem;opacity:0.9;">
                        ...
                        <span><i class="fas fa-clock me-1"></i>{{ $announcementData['published_at'] ?? '-' }} ({{ $announcementData['published_at_human'] ?? '' }})</span>
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-8">
            <div class="modern-card p-4">
                <h5 class="mb-4" style="font-weight:700;color:#1e293b;border-bottom:2px solid #f1f5f9;padding-bottom:0.75rem;">
                    <i class="fas fa-file-alt me-2" style="color:#f59e0b;"></i>Isi Pengumuman
                </h5>
        ...
        <div class="col-xl-4">
            ...
            {{-- Navigation --}}
            <div class="modern-card p-4">
                <h5 class="mb-3" style="font-weight:700;color:#1e293b;"><i class="fas fa-compass me-2" style="color:#f59e0b;"></i>Navigasi</h5>
                <a href="{{ route('student.announcements.index') }}" class="action-btn w-100 justify-content-center" style="background:#f1f5f9;color:#64748b;">
